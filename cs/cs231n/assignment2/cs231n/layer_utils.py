...
def affine_bn_relu_forward(x, w, b, gamma, beta, bn_params):
    """
    Convenience layer that perorms an affine transform followed by a batach normalize and ReLU
    ...
    Reture a tuple of:
    - out : Ouput from the ReLU
    - cache : Object to give a backward pass
    """
...
def affine_bn_relu_backward(dout, cache):
    ...
    dbn_in, dgamma, dbeta = batchnorm_backward(dbn_out, bn_cache)
    dx, dw, db = affine_backward(dbn_in, affine_cache)
